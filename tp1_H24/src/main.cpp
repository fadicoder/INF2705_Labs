...
int main(int argc, char* argv[])
{
    ...
    { 
        ...
        // au programme.
        Shader fragShader = Shader(GL_FRAGMENT_SHADER, str.c_str());
        Shader vertShader = Shader(GL_VERTEX_SHADER, vstr.c_str());
    ...
    BasicShapeArrays shape{&triVertices, sizeof(triVertices));
